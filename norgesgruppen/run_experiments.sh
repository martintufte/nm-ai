...
"1|detect_v8n_1280|--name detect_v8n_1280 --model-size n --epochs 100 --imgsz 1280 --batch -1 --patience 20"

# 2) YOLOv8-S (11M params, good speed/accuracy tradeoff)
"2|detect_v8s_1280|--name detect_v8s_1280 --model-size s --epochs 100 --imgsz 1280 --batch -1 --patience 20"

# 3) YOLOv8-M (25M params, strong baseline)
"3|detect_v8m_1280|--name detect_v8m_1280 --model-size m --epochs 100 --imgsz 1280 --batch -1 --patience 20"

# 4) YOLOv8-L (43M params, more capacity)
"4|detect_v8l_1280|--name detect_v8l_1280 --model-size l --epochs 80 --imgsz 1280 --batch -1 --patience 20"

# 5) YOLOv8-X (68M params, maximum capacity, check if L4 24GB fits)
"5|detect_v8x_1280|--name detect_v8x_1280 --model-size x --epochs 60 --imgsz 1280 --batch -1 --patience 20"
...
"6|detect_v8m_1600|--name detect_v8m_1600 --model-size m --epochs 80 --imgsz 1600 --batch -1 --patience 20"

# 7) Best-size with stronger augmentation (heavy mosaic + copy-paste for dense scenes)
"7|detect_v8m_1280_aug|--name detect_v8m_1280_aug --model-size m --epochs 100 --imgsz 1280 --batch -1 --patience 20 --mosaic 1.0 --mixup 0.2"

# 8) Best-size with lower LR (sometimes helps with small datasets)
"8|detect_v8m_1280_lowlr|--name detect_v8m_1280_lowlr --model-size m --epochs 100 --imgsz 1280 --batch -1 --patience 25 --lr0 0.0005"

# 9) YOLOv8-M with SGD instead of AdamW
"9|detect_v8m_1280_sgd|--name detect_v8m_1280_sgd --model-size m --epochs 100 --imgsz 1280 --batch -1 --patience 20 --optimizer SGD --lr0 0.01"
...
"10|classify_v8m_1280|--name classify_v8m_1280 --model-size m --epochs 120 --imgsz 1280 --batch -1 --patience 30 --multi-class --lr0 0.0005"

# 11) Multi-class from scratch (compare vs fine-tuning from detection)
"11|classify_v8m_1280_scratch|--name classify_v8m_1280_scratch --model-size m --epochs 120 --imgsz 1280 --batch -1 --patience 30 --multi-class --lr0 0.001"
)
